...
public class SearchStatistics {
	...
	public void incrementDeltaPrunes() {
		deltaPrunes++;
	}

	public void incrementExtendedFutilityPrunes() {
		extendedFutilityPrunes++;
	}

	// Futility statistics getters and incrementers
	public void incrementFutilityPrunes() {
		futilityPrunes++;
	}

	public void incrementMoveCountPrunes() {
		moveCountPrunes++;
	}

	public void incrementNullWindowSearches() {
		nullWindowSearches++;
	}
	...
	public void incrementPvsFailHigh() {
		pvsFailHigh++;
	}

	public void incrementPvsFailLow() {
		pvsFailLow++;
	}

	// PVS statistics getters and incrementers
	public void incrementPvsNodes() {
		pvsNodes++;
	}

	public void incrementPvsResearches() {
		pvsResearches++;
	}

	public void incrementQFutilityPrunes() {
		qFutilityPrunes++;
	}
	...
	public void incrementSeePrunes() {
		seePrunes++;
	}
