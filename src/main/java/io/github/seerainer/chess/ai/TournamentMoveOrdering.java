...
public class TournamentMoveOrdering {
    ...
    private TournamentMoveOrdering() {
	...
	private int evaluateMove(final Move move) {
		...
		score += 10000 + MaterialEvaluator.getPieceValue(captured.getPieceType())
			- MaterialEvaluator.getPieceValue(attacker.getPieceType());
	    }

	    // 2. Promotions
	    if (move.getPromotion() != Piece.NONE) {
		score += 9000 + MaterialEvaluator.getPieceValue(move.getPromotion().getPieceType());
	    }
