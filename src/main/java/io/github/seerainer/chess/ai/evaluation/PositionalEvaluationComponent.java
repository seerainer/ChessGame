...
/**
 * Enhanced piece-square table evaluation with separate middlegame and endgame
 * tables Based on modern chess engine principles for optimal positional play
 */
public class PositionalEvaluationComponent implements EvaluationComponent {
    ...
    private static final int[][] PAWN_EG_TABLE = {
        {  0,  0,  0,  0,  0,  0,  0,  0},
    ...
    private static final int[][] KNIGHT_MG_TABLE = {
    ...
    private static final int[][] KNIGHT_EG_TABLE = {
    ...
    private static final int[][] BISHOP_MG_TABLE = {
    ...
    private static final int[][] BISHOP_EG_TABLE = {
    ...
    private static final int[][] ROOK_MG_TABLE = {
    ...
    private static final int[][] ROOK_EG_TABLE = {
    ...
    private static final int[][] QUEEN_MG_TABLE = {
    ...
    private static final int[][] QUEEN_EG_TABLE = {
