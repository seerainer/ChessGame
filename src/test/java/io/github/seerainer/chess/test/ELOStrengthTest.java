...
public class ELOStrengthTest {
	...
	System.out.println(new StringBuilder().append("- Passed: ").append(passedTests).append(" (")
		.append("%.1f".formatted(passRate)).append("%)").toString());
	System.out.println(new StringBuilder().append("- Average time per position: ").append("%.1f".formatted(avgTime))
		.append("ms").toString());
	System.out.println(new StringBuilder().append("- Average difficulty: ").append("%.1f".formatted(avgDifficulty))
		.append("/10").toString());
	System.out.println(new StringBuilder().append("- Weighted pass rate: ")
		.append("%.1f".formatted(weightedPassRate)).append("%").toString());
	...
	for (var diff = 1; diff <= 10; diff++) {
		...
		System.out.println(new StringBuilder().append("- Difficulty ").append(difficulty).append(": ")
			.append(passedAtDifficulty).append("/").append(totalAtDifficulty).append(" (")
			.append("%.1f".formatted(successRate)).append("%)").toString());
	    }
	}
	...
	System.out.println(new StringBuilder().append("\n--- Running ").append(suiteName).append(" ---").toString());

	for (var i = 0; i < positions.size(); i++) {
	    final var pos = positions.get(i);
	    System.out.println(new StringBuilder().append("\nTest ").append(i + 1).append(": ").append(pos.description)
		    .toString());
